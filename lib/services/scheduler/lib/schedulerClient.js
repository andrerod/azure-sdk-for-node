...
var JobOperations = ( /** @lends JobOperations */ function() {
   ...
   * 
   * @param {object} [parameters.action.errorAction.request.headers] pair of
   * strings representing header name value pairs.
   * 
   ...
   * PUT, POST, DELETE.
   * 
   * @param {object} [parameters.action.request.headers] pair of strings
