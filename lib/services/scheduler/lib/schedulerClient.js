 ...
 * @class
 */
var SchedulerClient = (function() {
  /**
   * Initializes a new instance of the SchedulerClient class.
   * @constructor
   * 
   * @param {SubscriptionCloudCredentials} credentials
   * 
   ...
   */
  function SchedulerClient(credentials, cloudServiceName, jobCollectionName, baseUri) {
    ...
    SchedulerClient['super_'].call(this, credentials);
...
var JobOperations = (function() {
   ...
   * 
   * @param {JobCreateParameters} parameters Parameters supplied to the Create
   * Job operation.
   * 
   ...
   * 
   * @param {IDictionary`2} [parameters.action.errorAction.request.headers]
   * pair of strings representing header name value pairs.
   * 
   * @param {string} [parameters.action.errorAction.request.body] HTTP request
   * body.
   * 
   ...
   * PUT, POST, DELETE.
   * 
   * @param {IDictionary`2} [parameters.action.request.headers] pair of strings
   * representing header name value pairs.
   * 
   * @param {string} [parameters.action.request.body] HTTP request body.
   * 
   * @param {JobQueueMessage} [parameters.action.queueMessage] Queue and
   * message for a queue message action type.
   * 
   ...
   * 
   * @param {string} [parameters.action.queueMessage.message] Message to send
   * to the queue.
   * 
  ...
  JobOperations.prototype.create = function(parameters, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + this.client.credentials.subscriptionId + '/cloudservices/' + this.client.cloudServiceName + '/resources/scheduler/~/JobCollections/' + this.client.jobCollectionName + '/jobs?api-version=2013-10-31_Preview';
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (responseDoc) {
        ...
        if (jobValue) {
          ...
          if (actionValue2) {
            ...
            if (retryPolicyValue2) {
              ...
              if (retryIntervalValue) {
                var retryIntervalInstance = retryIntervalValue;
            ...
            if (errorActionValue2) {
              ...
              if (requestValue3) {
                ...
                if (headersSequenceElement) {
                  for (var loweredIndex7 = 0; loweredIndex7 < headersSequenceElement.length; loweredIndex7 = loweredIndex7 + 1) {
                    var property = headersSequenceElement[loweredIndex7];
            ...
            if (requestValue4) {
              ...
              if (headersSequenceElement2) {
                for (var loweredIndex8 = 0; loweredIndex8 < headersSequenceElement2.length; loweredIndex8 = loweredIndex8 + 1) {
                  var property2 = headersSequenceElement2[loweredIndex8];
          ...
          var recurrenceValue2 = jobValue['recurrence'];
          if (recurrenceValue2) {
            ...
            if (scheduleValue2) {
              ...
              if (minutesArray2) {
                for (var loweredIndex9 = 0; loweredIndex9 < minutesArray2.length; loweredIndex9 = loweredIndex9 + 1) {
                  var minutesValue = minutesArray2[loweredIndex9];
              ...
              if (hoursArray2) {
                for (var loweredIndex10 = 0; loweredIndex10 < hoursArray2.length; loweredIndex10 = loweredIndex10 + 1) {
                  var hoursValue = hoursArray2[loweredIndex10];
              ...
              if (weekDaysArray2) {
                for (var loweredIndex11 = 0; loweredIndex11 < weekDaysArray2.length; loweredIndex11 = loweredIndex11 + 1) {
                  var weekDaysValue = weekDaysArray2[loweredIndex11];
              ...
              if (monthsArray2) {
                for (var loweredIndex12 = 0; loweredIndex12 < monthsArray2.length; loweredIndex12 = loweredIndex12 + 1) {
                  var monthsValue = monthsArray2[loweredIndex12];
              ...
              if (monthDaysArray2) {
                for (var loweredIndex13 = 0; loweredIndex13 < monthDaysArray2.length; loweredIndex13 = loweredIndex13 + 1) {
                  var monthDaysValue = monthDaysArray2[loweredIndex13];
              ...
              if (monthlyOccurrencesArray2) {
                for (var loweredIndex14 = 0; loweredIndex14 < monthlyOccurrencesArray2.length; loweredIndex14 = loweredIndex14 + 1) {
                  var monthlyOccurrencesValue = monthlyOccurrencesArray2[loweredIndex14];
          ...
          var statusValue = jobValue['status'];
          if (statusValue) {
            var statusInstance = {};
   ...
   * 
   * @param {JobCreateOrUpdateParameters} parameters Parameters supplied to the
   * job operation.
   * 
   * @param {date} [parameters.startTime] Start time for the job. Defined as
   * ISO-8601.
  ...
  JobOperations.prototype.createOrUpdate = function(jobId, parameters, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + this.client.credentials.subscriptionId + '/cloudservices/' + this.client.cloudServiceName + '/resources/scheduler/~/JobCollections/' + this.client.jobCollectionName + '/jobs/' + jobId + '?api-version=2013-10-31_Preview';
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (responseDoc) {
        ...
        if (jobValue) {
          ...
          var actionValue = jobValue['action'];
          if (actionValue) {
            var actionInstance = {};
            jobInstance.action = actionInstance;
            ...
            if (errorActionValue) {
              ...
              if (requestValue) {
                ...
                if (headersSequenceElement) {
                  for (var loweredIndex1 = 0; loweredIndex1 < headersSequenceElement.length; loweredIndex1 = loweredIndex1 + 1) {
                    var property = headersSequenceElement[loweredIndex1];
            ...
            if (requestValue2) {
              ...
              if (headersSequenceElement2) {
                for (var loweredIndex2 = 0; loweredIndex2 < headersSequenceElement2.length; loweredIndex2 = loweredIndex2 + 1) {
                  var property2 = headersSequenceElement2[loweredIndex2];
          ...
          var recurrenceValue = jobValue['recurrence'];
          if (recurrenceValue) {
            var recurrenceInstance = {};
            jobInstance.recurrence = recurrenceInstance;
            ...
            if (scheduleValue) {
              ...
              if (minutesArray) {
                for (var loweredIndex3 = 0; loweredIndex3 < minutesArray.length; loweredIndex3 = loweredIndex3 + 1) {
                  var minutesValue = minutesArray[loweredIndex3];
                  scheduleInstance.minutes.push(minutesValue);
                }
              }
              ...
              if (weekDaysArray) {
                for (var loweredIndex5 = 0; loweredIndex5 < weekDaysArray.length; loweredIndex5 = loweredIndex5 + 1) {
                  var weekDaysValue = weekDaysArray[loweredIndex5];
                  scheduleInstance.days.push(weekDaysValue);
                }
              }
              ...
              if (monthsArray) {
                for (var loweredIndex6 = 0; loweredIndex6 < monthsArray.length; loweredIndex6 = loweredIndex6 + 1) {
                  var monthsValue = monthsArray[loweredIndex6];
                  scheduleInstance.months.push(monthsValue);
                }
              }
              ...
              if (monthDaysArray) {
                for (var loweredIndex7 = 0; loweredIndex7 < monthDaysArray.length; loweredIndex7 = loweredIndex7 + 1) {
                  var monthDaysValue = monthDaysArray[loweredIndex7];
                  scheduleInstance.monthDays.push(monthDaysValue);
                }
              }
              ...
              if (monthlyOccurrencesArray) {
                for (var loweredIndex8 = 0; loweredIndex8 < monthlyOccurrencesArray.length; loweredIndex8 = loweredIndex8 + 1) {
                  var monthlyOccurrencesValue = monthlyOccurrencesArray[loweredIndex8];
                  var jobScheduleMonthlyOccurrenceInstance = {};
                  scheduleInstance.monthlyOccurrences.push(jobScheduleMonthlyOccurrenceInstance);
  ...
  JobOperations.prototype.getHistory = function(jobId, parameters, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + this.client.credentials.subscriptionId + '/cloudservices/' + this.client.cloudServiceName + '/resources/scheduler/~/JobCollections/' + this.client.jobCollectionName + '/jobs/' + jobId + '/history?api-version=2013-10-31_Preview&$skip=' + parameters.skip + '&$top=' + parameters.top;
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (responseDoc) {
        var jobHistoryArray = responseDoc['JobHistory'];
        if (jobHistoryArray) {
          for (var loweredIndex1 = 0; loweredIndex1 < jobHistoryArray.length; loweredIndex1 = loweredIndex1 + 1) {
            ...
            var recordNumberValue = jobHistoryValue['recordNumber'];
            if (recordNumberValue) {
              var recordNumberInstance = recordNumberValue;
  ...
  JobOperations.prototype.getHistoryWithFilter = function(jobId, parameters, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + this.client.credentials.subscriptionId + '/cloudservices/' + this.client.cloudServiceName + '/resources/scheduler/~/JobCollections/' + this.client.jobCollectionName + '/jobs/' + jobId + '/history?api-version=2013-10-31_Preview&$filter=status eq ' + parameters.status + '&$skip=' + parameters.skip + '&$top=' + parameters.top;
  ...
  JobOperations.prototype.list = function(parameters, callback) {
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (responseDoc) {
        var jobsArray = responseDoc['Jobs'];
        if (jobsArray) {
          for (var loweredIndex1 = 0; loweredIndex1 < jobsArray.length; loweredIndex1 = loweredIndex1 + 1) {
            ...
            if (actionValue) {
              ...
              if (errorActionValue) {
                ...
                if (requestValue) {
                  ...
                  var headersSequenceElement = requestValue['headers'];
                  if (headersSequenceElement) {
                    for (var loweredIndex2 = 0; loweredIndex2 < headersSequenceElement.length; loweredIndex2 = loweredIndex2 + 1) {
                      var property = headersSequenceElement[loweredIndex2];
                      var headersKey = property;
                      var headersValue = headersSequenceElement[property];
                      requestInstance.headers[headersKey] = headersValue;
                    }
              ...
              if (requestValue2) {
                ...
                var headersSequenceElement2 = requestValue2['headers'];
                if (headersSequenceElement2) {
                  for (var loweredIndex3 = 0; loweredIndex3 < headersSequenceElement2.length; loweredIndex3 = loweredIndex3 + 1) {
                    var property2 = headersSequenceElement2[loweredIndex3];
                    var headersKey2 = property2;
                    var headersValue2 = headersSequenceElement2[property2];
                    requestInstance2.headers[headersKey2] = headersValue2;
                  }
            ...
            if (recurrenceValue) {
              ...
              if (scheduleValue) {
                ...
                var minutesArray = scheduleValue['minutes'];
                if (minutesArray) {
                  for (var loweredIndex4 = 0; loweredIndex4 < minutesArray.length; loweredIndex4 = loweredIndex4 + 1) {
                    var minutesValue = minutesArray[loweredIndex4];
                    scheduleInstance.minutes.push(minutesValue);
                  }
                }
                ...
                var weekDaysArray = scheduleValue['weekDays'];
                if (weekDaysArray) {
                  for (var loweredIndex6 = 0; loweredIndex6 < weekDaysArray.length; loweredIndex6 = loweredIndex6 + 1) {
                    var weekDaysValue = weekDaysArray[loweredIndex6];
                    scheduleInstance.days.push(weekDaysValue);
                  }
                }
                ...
                var monthsArray = scheduleValue['months'];
                if (monthsArray) {
                  for (var loweredIndex7 = 0; loweredIndex7 < monthsArray.length; loweredIndex7 = loweredIndex7 + 1) {
                    var monthsValue = monthsArray[loweredIndex7];
                    scheduleInstance.months.push(monthsValue);
                  }
                }
                ...
                var monthDaysArray = scheduleValue['monthDays'];
                if (monthDaysArray) {
                  for (var loweredIndex8 = 0; loweredIndex8 < monthDaysArray.length; loweredIndex8 = loweredIndex8 + 1) {
                    var monthDaysValue = monthDaysArray[loweredIndex8];
                    scheduleInstance.monthDays.push(monthDaysValue);
                  }
                }
                ...
                var monthlyOccurrencesArray = scheduleValue['monthlyOccurrences'];
                if (monthlyOccurrencesArray) {
                  for (var loweredIndex9 = 0; loweredIndex9 < monthlyOccurrencesArray.length; loweredIndex9 = loweredIndex9 + 1) {
                    var monthlyOccurrencesValue = monthlyOccurrencesArray[loweredIndex9];
                    var jobScheduleMonthlyOccurrenceInstance = {};
                    scheduleInstance.monthlyOccurrences.push(jobScheduleMonthlyOccurrenceInstance);
  ...
  JobOperations.prototype.listWithFilter = function(parameters, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + this.client.credentials.subscriptionId + '/cloudservices/' + this.client.cloudServiceName + '/resources/scheduler/~/JobCollections/' + this.client.jobCollectionName + '/jobs?api-version=2013-10-31_Preview&$filter=state eq ' + parameters.state;
    if (parameters.skip) {
      url2 = url2 + '&$skip=' + encodeURIComponent(parameters.skip.toString());
    }
    if (parameters.top) {
   ...
   * 
   * @param {JobState} parameters.state
   * 
   * @param {function} callback
   * 
   * @returns {Stream} The response stream.
  ...
  JobOperations.prototype.updateJobCollectionState = function(parameters, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + this.client.credentials.subscriptionId + '/cloudservices/' + this.client.cloudServiceName + '/resources/scheduler/~/JobCollections/' + this.client.jobCollectionName + '/jobs';
   ...
   * @param {JobState} parameters.state
   * 
   * @param {string} [parameters.updateStateReason]
   * 
   * @param {function} callback
   * 
   * @returns {Stream} The response stream.
