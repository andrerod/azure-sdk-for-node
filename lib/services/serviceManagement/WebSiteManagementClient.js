...
var WebSiteManagementClient = (function() {
    ...
    WebSiteManagementClient.prototype.registerSubscription = function(callback) {
        ...
        // Set Credentials
        // TODO: Apply credentials to request
...
var WebSiteOperations = (function() {
     ...
     * @constructor
     *
     * @param {WebSiteManagementClient} client - Reference to the service
     * client.
     */
     ...
     *
     * @param {WebSiteUpdateHostNamesParameters} parameters - Parameters
     * supplied to the Update Web Site Host Names operation.
     *
     * @param {Function} callback
     *
     * @returns {WebSiteUpdateHostNamesResponse} - The Update Web Site
     * operation response.
     */
    WebSiteOperations.prototype.updateHostNames = function(webSpaceName, webSiteName, parameters, callback) {
        ...
        if (webSpaceName === null || webSpaceName === undefined) {
            return callback("webSpaceName cannot be null.");
        }
        if (webSiteName === null || webSiteName === undefined) {
            return callback("webSiteName cannot be null.");
        }
        if (parameters === null || parameters === undefined) {
            return callback("parameters cannot be null.");
        }
        if (parameters.hostNames === null || parameters.hostNames === undefined) {
            return callback("parameters.hostNames cannot be null.");
        }
        ...
        requestContent = js2xml.serialize(requestDoc);
        ...
        return request(httpRequest, function (err, response, body) {
            ...
            return xml.parseString(responseContent, options, function (err2, responseDoc) {
                ...
                if (siteElement2) {
                    ...
                    var webSiteInstance = {};
                    webSiteInstance.enabledHostNames = [];
                    webSiteInstance.hostNameSslStates = [];
                    webSiteInstance.hostNames = [];
                    webSiteInstance.sslCertificates = [];
                    var webSiteInstance = webSiteInstance;
                    ...
                    if (sSLCertificatesSequenceElement) {
                        for (var loweredIndex5 = 0; loweredIndex5 < sSLCertificatesSequenceElement.CERTIFICATE.length; loweredIndex5 = loweredIndex5 + 1) {
                            ...
                            var webSite.WebSiteSslCertificateInstance = {};
                            webSite.WebSiteSslCertificateInstance.hostNames = [];
                            var certificateInstance = webSite.WebSiteSslCertificateInstance;
                    ...
                    if (sitePropertiesElement) {
                        var webSite.WebSitePropertiesInstance = {};
                        webSite.WebSitePropertiesInstance.appSettings = {};
                        webSite.WebSitePropertiesInstance.metadata = {};
                        webSite.WebSitePropertiesInstance.properties = {};
                        var sitePropertiesInstance = webSite.WebSitePropertiesInstance;
     ...
     * @param {Function} callback
     *
     * @returns {WebSiteCreateResponse} - The Create Web Space operation
     * response.
     */
     ...
     * (see
     * http://msdn.microsoft.com/en-us/library/windowsazure/dn167007.aspx for
     * more information)
     *
     * @param {String} webSpaceName - The name of the web space.
     *
     ...
     * @param {Function} callback
     *
     * @returns {WebSiteUpdateResponse} - The Update Web Site operation
     * response.
     */
    ...
    /**
     * You can enable or disable SSL for a web site by using the HTTP PUT
     * method and by specifying the settings in the request body. This
     * operation is similar to Update Web Site Settings, but the request body
     * is SSL-specific.  Important: For Windows Azure Websites, SSL support is
     ...
     * @param {String} webSiteName - The name of the web site.
     *
     * @param {Boolean} deleteEmptyServerFarm - If the site being deleted is
     * the last web site in a server farm, you can delete the server farm.
     *
     * @param {Boolean} deleteMetrics - Delete the metrics for the site that
     * you are deleting
     *
     * @param {Function} callback
     *
     ...
     * providing a request body.  Note: The instance size and instance count
     * for a web site are determined by the server farm to which a site
     * belongs. To change these values, you must change the server farm
     * WorkerSize and NumberOfWorkers attributes, respectively. For more
     * information, see Create, Manage, or Delete a Server Farm.  (see
     ...
     * @param {String} webSiteName - The name of the web site.
     *
     * @param {WebSiteUpgradeParameters} parameters - Parameters supplied to
     * the Upgrade Web Site operation.
     *
     * @param {Function} callback
     *
    ...
    /**
     * A web site repository is essentially a GIT repository that you can use
     * to manage your web site content. By using GIT source control tools, you
     * can push or pull version controlled changes to your site. You can
     * create a repository for your web site by issuing an HTTP POST request,
     * or retrieve information about the repository by using HTTP GET.  (see
    ...
    WebSiteOperations.prototype.getPublishProfile = function(webSpaceName, webSiteName, callback) {
        ...
        return request(httpRequest, function (err, response, body) {
            ...
            // Create Result
            var webSiteGetPublishProfileResponseInstance = {};
            webSiteGetPublishProfileResponseInstance.publishProfiles = [];
            var result = webSiteGetPublishProfileResponseInstance;
            result.statusCode = statusCode;
            result.requestId = response.headers["x-ms-request-id"];
                ...
                if (publishDataElement) {
                    ...
                    if (publishDataElement) {
                        for (var loweredIndex1 = 0; loweredIndex1 < publishDataElement.PUBLISHPROFILE.length; loweredIndex1 = loweredIndex1 + 1) {
                            ...
                            var webSiteGetPublishProfileResponse.PublishProfileInstance = {};
                            webSiteGetPublishProfileResponse.PublishProfileInstance.databases = [];
                            var publishProfileInstance = webSiteGetPublishProfileResponse.PublishProfileInstance;
    ...
    WebSiteOperations.prototype.getConfiguration = function(webSpaceName, webSiteName, callback) {
        ...
        return request(httpRequest, function (err, response, body) {
            ...
            // Create Result
            var webSiteGetConfigurationResponseInstance = {};
            webSiteGetConfigurationResponseInstance.connectionStrings = [];
            webSiteGetConfigurationResponseInstance.defaultDocuments = [];
            webSiteGetConfigurationResponseInstance.handlerMappings = [];
            webSiteGetConfigurationResponseInstance.appSettings = {};
            webSiteGetConfigurationResponseInstance.metadata = {};
            var result = webSiteGetConfigurationResponseInstance;
            result.statusCode = statusCode;
            result.requestId = response.headers["x-ms-request-id"];
            ...
            return xml.parseString(responseContent, options, function (err2, responseDoc) {
                ...
                if (siteConfigElement) {
                    ...
                    if (requestTracingExpirationTimeElement) {
     ...
     * @param {String} webSiteName - The name of the web site.
     *
     * @param {WebSiteUpdateConfigurationParameters} parameters - The Update
    ...
    WebSiteOperations.prototype.updateConfiguration = function(webSpaceName, webSiteName, parameters, callback) {
        ...
        return request(httpRequest, function (err, response, body) {
            ...
            // Create Result
            var webSiteUpdateConfigurationResponseInstance = {};
            webSiteUpdateConfigurationResponseInstance.connectionStrings = [];
            webSiteUpdateConfigurationResponseInstance.defaultDocuments = [];
            webSiteUpdateConfigurationResponseInstance.handlerMappings = [];
            webSiteUpdateConfigurationResponseInstance.appSettings = {};
            webSiteUpdateConfigurationResponseInstance.metadata = {};
            var result = webSiteUpdateConfigurationResponseInstance;
            result.statusCode = statusCode;
            result.requestId = response.headers["x-ms-request-id"];
     ...
     * request. The metrics returned include CPU Time, Data In, Data Out,
     * Local bytes read, Local bytes written, Network bytes read, Network
     * bytes written, WP stop requests, Memory Usage, CPU Time - Minute Limit,
     * and File System Storage.  (see
     ...
     * @param {Function} callback
     *
     * @returns {WebSiteGetUsageMetricsResponse} - The Get Web Site Usage
    ...
    WebSiteOperations.prototype.getUsageMetrics = function(webSpaceName, webSiteName, callback) {
        ...
        return request(httpRequest, function (err, response, body) {
            ...
            // Create Result
            var webSiteGetUsageMetricsResponseInstance = {};
            webSiteGetUsageMetricsResponseInstance.usageMetrics = [];
            var result = webSiteGetUsageMetricsResponseInstance;
            result.statusCode = statusCode;
            result.requestId = response.headers["x-ms-request-id"];
    ...
    WebSiteOperations.prototype.getHistoricalUsageMetrics = function(webSpaceName, webSiteName, parameters, callback) {
        ...
        return request(httpRequest, function (err, response, body) {
            ...
            // Create Result
            var webSiteGetHistoricalUsageMetricsResponseInstance = {};
            webSiteGetHistoricalUsageMetricsResponseInstance.usageMetrics = [];
            var result = webSiteGetHistoricalUsageMetricsResponseInstance;
            result.statusCode = statusCode;
            result.requestId = response.headers["x-ms-request-id"];
                ...
                if (metricResponsesElement) {
                    ...
                    if (metricResponsesElement) {
                        for (var loweredIndex1 = 0; loweredIndex1 < metricResponsesElement.METRICRESPONSE.length; loweredIndex1 = loweredIndex1 + 1) {
                            ...
                            if (dataElement) {
                                var webSiteGetHistoricalUsageMetricsResponse.HistoricalUsageMetricDataInstance = {};
                                webSiteGetHistoricalUsageMetricsResponse.HistoricalUsageMetricDataInstance.values = [];
                                var dataInstance = webSiteGetHistoricalUsageMetricsResponse.HistoricalUsageMetricDataInstance;
...
var WebSpaceOperations = (function() {
     ...
     * @param {Function} callback
     *
     * @returns {WebSpacesListResponse} - The List Web Spaces operation
     * response.
     */
    WebSpaceOperations.prototype.list = function(callback) {
        ...
        return request(httpRequest, function (err, response, body) {
            ...
            // Create Result
            var webSpacesListResponseInstance = {};
            webSpacesListResponseInstance.webSpaces = [];
            var result = webSpacesListResponseInstance;
            result.statusCode = statusCode;
            result.requestId = response.headers["x-ms-request-id"];
    ...
    /**
     * You can retrieve details for a specified webspace name by issuing an
    ...
    WebSpaceOperations.prototype.listPublishingUsers = function(callback) {
        ...
        return request(httpRequest, function (err, response, body) {
            ...
            // Create Result
            var webSpacesListPublishingUsersResponseInstance = {};
            webSpacesListPublishingUsersResponseInstance.users = [];
            var result = webSpacesListPublishingUsersResponseInstance;
            result.statusCode = statusCode;
            result.requestId = response.headers["x-ms-request-id"];
    ...
    WebSpaceOperations.prototype.listWebsites = function(webSpaceName, callback) {
        ...
        return request(httpRequest, function (err, response, body) {
            ...
            // Create Result
            var webSpacesListWebsitesResponseInstance = {};
            webSpacesListWebsitesResponseInstance.webSites = [];
            var result = webSpacesListWebsitesResponseInstance;
            result.statusCode = statusCode;
            result.requestId = response.headers["x-ms-request-id"];
            ...
            return xml.parseString(responseContent, options, function (err2, responseDoc) {
                ...
                if (sitesSequenceElement) {
                    for (var loweredIndex1 = 0; loweredIndex1 < sitesSequenceElement.SITE.length; loweredIndex1 = loweredIndex1 + 1) {
                        ...
                        webSiteInstance.hostNames = [];
                        webSiteInstance.sslCertificates = [];
                        var siteInstance = webSiteInstance;
     ...
     * @param {Function} callback
     *
     * @returns {WebSpacesListGeoRegionsResponse} - The Get DNS Suffix
     * operation response.
     */
    WebSpaceOperations.prototype.listGeoRegions = function(callback) {
        ...
        return request(httpRequest, function (err, response, body) {
            ...
            // Create Result
            var webSpacesListGeoRegionsResponseInstance = {};
            webSpacesListGeoRegionsResponseInstance.geoRegions = [];
            var result = webSpacesListGeoRegionsResponseInstance;
            result.statusCode = statusCode;
            result.requestId = response.headers["x-ms-request-id"];
...
var ServerFarmOperations = (function() {
     ...
     * @param {String} webSpaceName - The name of the web space.
     *
     * @param {ServerFarmUpdatedParameters} parameters - Parameters supplied to
     * the Updated Server Farm operation.
     *
     * @param {Function} callback
     *
     * @returns {ServerFarmUpdatedResponse} - The Updated Server Farm operation
     * response.
     */
    ServerFarmOperations.prototype.updated = function(webSpaceName, parameters, callback) {
        if (callback === null || callback === undefined) {
            throw "callback cannot be null.";
        }
        // Validate
     ...
     * @param {Function} callback
     *
     * @returns {ServerFarmGetResponse} - The Get Server Farm operation
     * response.
     */
