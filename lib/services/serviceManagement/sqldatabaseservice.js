...
* @param {function} callback            function (err, results, response) The callback function called on completion. Required.
*/
SqlDatabaseService.prototype.getServerDatabase = function (serverName, databaseName, callback) {
  var path = this._makePath('servers') + '/' + serverName + '/databases/' + databaseName;
  var webResource = WebResource.get(path);
  webResource.withOkCode(HttpConstants.HttpResponseCodes.OK_CODE, true);
...
* @param {function} callback            function (err, results, response) The callback function called on completion. Required.
*/
SqlDatabaseService.prototype.listServerDatabases = function (serverName, callback) {
