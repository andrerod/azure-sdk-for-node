...
var SqlServerAcs = require('../serviceManagement/sqlserveracs');
var Constants = require('../../util/constants');
var HeaderConstants = Constants.HeaderConstants;
var QueryStringConstants = Constants.QueryStringConstants;
var HttpConstants = Constants.HttpConstants;

// Expose 'SqlServerDatabaseClient'.
exports = module.exports = SqlServerDatabaseClient;

/**
* Creates a new SqlServerDatabaseClient object.
*
* @constructor
...
*/
function SqlServerDatabaseClient(administratorLogin, administratorLoginPassword, host, acsHost, authenticationProvider) {
  SqlServerDatabaseClient.super_.call(this, host, authenticationProvider);

  this.authenticationProvider = authenticationProvider;
  if (!this.authenticationProvider) {
    this.authenticationProvider = new SqlServerAcs(acsHost, administratorLogin, administratorLoginPassword);
  }
}

util.inherits(SqlServerDatabaseClient, ServiceClient);
...
*/
SqlServerDatabaseClient.prototype._buildRequestOptions = function (webResource, options, callback) {
  var self = this;
...
*/
SqlServerDatabaseClient.prototype._getPath = function (path) {
