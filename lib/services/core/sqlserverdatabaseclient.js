...
* Error messages.
*/
SqlServerDatabaseClient.missingKeyValue = 'Client private key certificate is required';
SqlServerDatabaseClient.missingCertValue = 'Client public certificate is required';
SqlServerDatabaseClient.invalidSerializeType = 'serializetype must be XML or JSON';

// Default API Version
SqlServerDatabaseClient.DefaultAPIVersion = '2012-03-01';
// Default serialization Type: XML or JSON
SqlServerDatabaseClient.DefaultSerializeType = 'JSON';
...
*                                         }
*/
function SqlServerDatabaseClient(authentication, hostOptions) {
  SqlServerDatabaseClient.super_.call(this);
