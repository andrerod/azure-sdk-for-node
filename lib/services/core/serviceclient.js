...
function ServiceClient(host, authenticationProvider) {
  ...
  this.xml2jsSettings = this._getDefaultXml2jsSettings();
}

util.inherits(ServiceClient, events.EventEmitter);

ServiceClient.defaultXml2jsSettings = function () {
  return _.extend(_.clone(xml2js.defaults['0.2']), {
    normalize: false,
    trim: false,
    attrkey: Constants.XML_METADATA_MARKER,
    charkey: Constants.XML_VALUE_MARKER,
    explicitArray: false
  });
};
...
*/
ServiceClient.prototype._getDefaultXml2jsSettings = function() {
...
ServiceClient.prototype._parseResponse = function (response) {
  ...
  function parseXml(body) {
    var parsed;
    var parser = new xml2js.Parser(self.xml2jsSettings);
