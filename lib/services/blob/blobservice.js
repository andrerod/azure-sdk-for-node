...
BlobService.prototype.getServiceProperties = function (optionsOrCallback, callback) {
  ...
  this._executeRequest(webResource, null, servicePropertiesResult, null, options, callback);
};
...
BlobService.prototype.setServiceProperties = function (serviceProperties, optionsOrCallback, callback) {
  ...
  this._executeRequest(webResource, servicePropertiesXml, null, null, options, callback);
};
...
BlobService.prototype.listContainers = function (optionsOrCallback, callback) {
  ...
  var self = this;
  this._executeRequest(webResource, null, listContainerResult, null, options, function (err, result, continuationToken, response) {
...
BlobService.prototype.createContainer = function (container, optionsOrCallback, callback) {
  ...
  this._executeRequest(webResource, null, containerResult, null, options, function (err, result, response) {
    if (!err) {
...
BlobService.prototype.setContainerMetadata = function (container, metadata, optionsOrCallback, callback) {
  ...
  this._executeRequest(webResource, null, null, null, options, callback);
};
...
BlobService.prototype.listBlobs = function (container, optionsOrCallback, callback) {
  ...
  var self = this;
  this._executeRequest(webResource, null, listBlobResult, null, options, function (err, result, continuationToken, response) {
...
BlobService.prototype.createBlockBlobFromText = function (container, blob, text, optionsOrCallback, callback) {
  ...
  this._executeRequest(webResource, text, blobResult, null, options, function (err, result, response) {
...
BlobService.prototype.getBlobProperties = function (container, blob, optionsOrCallback, callback) {
  ...
  this._executeRequest(webResource, null, blobResult, null, options, function (err, result, response) {
    if (!err) { result.blob = blob; result.container = container; }
    callback(err, result, response);
  });
};
...
BlobService.prototype.copyBlob = function (sourceContainer, sourceBlob, targetContainer, targetBlob, optionsOrCallback, callback) {
  ...
  this._executeRequest(webResource, null, blobResult, null, options, callback);
};
...
BlobService.prototype.clearBlobPages = function (container, blob, rangeStart, rangeEnd, optionsOrCallback, callback) {
  ...
  var webResource = this._updatePageBlobPagesImpl(container, blob, 0, rangeStart, rangeEnd, BlobConstants.PageWriteOptions.CLEAR, options);
  this._executeRequest(webResource, null, null, null, options, callback);
};
...
BlobService.prototype.createBlobPagesFromText = function (container, blob, text, rangeStart, rangeEnd, optionsOrCallback, callback) {
  ...
  var webResource = this._updatePageBlobPagesImpl(container, blob, text.length, rangeStart, rangeEnd, BlobConstants.PageWriteOptions.UPDATE, options);
  this._executeRequest(webResource, text, blobResult, null, options, callback);
};
...
BlobService.prototype.createBlobBlockFromText = function (blockId, container, blob, content, optionsOrCallback, callback) {
  ...
  this._executeRequest(webResource, content, null, null, options, callback);
};
...
BlobService.prototype.listBlobBlocks = function (container, blob, blocklisttype, optionsOrCallback, callback) {
  ...
  this._executeRequest(webResource, null, blockListResult, null, null, callback);
};
