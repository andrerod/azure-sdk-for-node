...
var listContainerResult = require('./models/listcontainerresult');
var containerResult = require('./models/containerresult');
var listBlobResult = require('./models/listblobresult');
...
BlobService.prototype.getServiceProperties = function (optionsOrCallback, callback) {
  ...
  this._executeRequest(request, null, servicePropertiesResult, null, options, callback);
};
...
BlobService.prototype.setServiceProperties = function (serviceProperties, optionsOrCallback, callback) {
  ...
  var request = Request.put().withOkCode(HttpConstants.HttpResponseCodes.Accepted)
    .withQueryOption(QueryStringConstants.COMP, 'properties')
    .withQueryOption(QueryStringConstants.RESTYPE, 'service')
  ...
  this._executeRequest(request, servicePropertiesXml, null, null, options, callback);
};
...
BlobService.prototype.listContainers = function (optionsOrCallback, callback) {
  ...
  var self = this;
  this._executeRequest(request, null, listContainerResult, null, options, function (err, result, continuationToken, response) {
    callback(err, result, new ListContainersResultContinuation(self, options, continuationToken), response);
  });
};
...
BlobService.prototype.createContainer = function (container, optionsOrCallback, callback) {
  ...
  var request = Request.put(container)
    .withProperty(BlobConstants.ResourceTypeProperty, BlobConstants.ResourceTypes.CONTAINER)
    ...
    .withHeader(HeaderConstants.BLOB_PUBLIC_ACCESS_HEADER, azureutil.tryGetValueInsensitive('publicAccessLevel', options))
    .addOptionalMetadataHeaders(azureutil.tryGetValueInsensitive('metadata', options));

  this._executeRequest(request, null, containerResult, null, options, function (err, result, response) {
    if (!err) {
...
BlobService.prototype.setContainerMetadata = function (container, metadata, optionsOrCallback, callback) {
  ...
  this._executeRequest(request, null, null, null, options, callback);
};
...
BlobService.prototype.getContainerAcl = function (container, optionsOrCallback, callback) {
  ...
  var request = Request.get(container)
    .withProperty(BlobConstants.ResourceTypeProperty, BlobConstants.ResourceTypes.CONTAINER)
    .withProperty(BlobConstants.SharedAccessPermissionProperty, BlobConstants.SharedAccessPermissions.READ)
    .withQueryOption(QueryStringConstants.RESTYPE, 'container')
  ...
  this._executeRequest(request, null, containerResult, null, options, function (err, result, response) {
    if (!err) {
      ...
      result.signedIdentifiers = ContainerAclResult.parse(response.body.SignedIdentifiers.SignedIdentifier);
    }
...
BlobService.prototype.setContainerAcl = function (container, publicAccessLevel, optionsOrCallback, callback) {
  ...
  this._executeRequest(request, null, containerResult, null, options, function (err, result, response) {
    if (!err) {
      ...
      result.signedIdentifiers = options.signedIdentifiers;
    }
...
BlobService.prototype.deleteContainer = function (container, optionsOrCallback, callback) {
  ...
  var request = Request.del(container)
...
BlobService.prototype.listBlobs = function (container, optionsOrCallback, callback) {
  ...
  var self = this;
  this._executeRequest(request, null, listBlobResult, null, options, function (err, result, continuationToken, response) {
    callback(err, result, new ListBlobsResultContinuation(self, options, continuationToken), response);
  });
};
...
BlobService.prototype.createPageBlob = function (container, blob, length, optionsOrCallback, callback) {
  ...
  var request = Request.put(resourceName)
    .withProperty(BlobConstants.ResourceTypeProperty, BlobConstants.ResourceTypes.BLOB)
    .withProperty(BlobConstants.SharedAccessPermissionProperty, BlobConstants.SharedAccessPermissions.WRITE)
    ...
    .withHeader(HeaderConstants.LEASE_ID_HEADER, azureutil.tryGetValueInsensitive('leaseId', options))
    .addOptionalMetadataHeaders(azureutil.tryGetValueInsensitive('metadata', options));
...
BlobService.prototype.createBlockBlobFromStream = function (container, blob, readStream, streamLength, optionsOrCallback, callback) {
  ...
  this._setHeadersFromBlob(request, options);

  if (!(request.headers && request.headers[HeaderConstants.BLOB_TYPE_HEADER])) {
    request.withHeader(HeaderConstants.BLOB_TYPE_HEADER, BlobConstants.BlobTypes.BLOCK);
  }

  var processResponseCallback = function (responseObject, next) {
    responseObject.blobResult = null;
    if (!responseObject.error) {
      responseObject.blobResult = blobResult.parse(responseObject.response)[0];
      responseObject.blobResult.blob = blob;
      responseObject.blobResult.container = container;
    }
...
BlobService.prototype.createBlockBlobFromText = function (container, blob, text, optionsOrCallback, callback) {
  ...
  this._executeRequest(request, text, blobResult, null, options, function (err, result, response) {
    if (!err) { result.blob = blob; result.container = container; }
    callback(err, result, response);
  });
};
...
BlobService.prototype.getBlobProperties = function (container, blob, optionsOrCallback, callback) {
  ...
  var resourceName = createResourceName(container, blob);
  var request = Request.head(resourceName)
    .withProperty(BlobConstants.ResourceTypeProperty, BlobConstants.ResourceTypes.BLOB)
    .withProperty(BlobConstants.SharedAccessPermissionProperty, BlobConstants.SharedAccessPermissions.READ)
    .withQueryOption(QueryStringConstants.SNAPSHOT, azureutil.tryGetValueInsensitive('snapshotId', options));

  this._setHeadersFromBlob(request, options);

  this._executeRequest(request, null, blobResult, null, options, function (err, result, response) {
    if (!err) { result.blob = blob; result.container = container; }
    callback(err, result, response);
  });
};
...
BlobService.prototype.setBlobProperties = function (container, blob, optionsOrCallback, callback) {
  ...
  var resourceName = createResourceName(container, blob);
  var request = Request.put(resourceName).withOkCode(HttpConstants.HttpResponseCodes.Ok)
    .withProperty(BlobConstants.ResourceTypeProperty, BlobConstants.ResourceTypes.BLOB)
    .withProperty(BlobConstants.SharedAccessPermissionProperty, BlobConstants.SharedAccessPermissions.WRITE)
    .withQueryOption(QueryStringConstants.COMP, 'properties');
...
BlobService.prototype.getBlobToStream = function (container, blob, writeStream, optionsOrCallback, callback) {
  ...
  var resourceName = createResourceName(container, blob);
  var request = Request.get(resourceName)
  ...
  this.performRequestInputStream(request, null, writeStream, options, processResponseCallback);
};
...
BlobService.prototype.getBlobToText = function (container, blob, optionsOrCallback, callback) {
  ...
  this._executeRequest(request, null, blobResult, null, options, function (err, result, response) {
    if (!err) { result.blob = blob; result.container = container; }
    callback(err, response.body, result, response);
  });
};
...
BlobService.prototype.deleteBlob = function (container, blob, optionsOrCallback, callback) {
  ...
  var resourceName = createResourceName(container, blob);
  var request = Request.del(resourceName)
    .withOkCode(HttpConstants.HttpResponseCodes.Accepted)
    .withProperty(BlobConstants.ResourceTypeProperty, BlobConstants.ResourceTypes.BLOB)
    .withProperty(BlobConstants.SharedAccessPermissionProperty, BlobConstants.SharedAccessPermissions.WRITE)
    .withQueryOption(QueryStringConstants.SNAPSHOT, azureutil.tryGetValueInsensitive('snapshotId', options));
...
BlobService.prototype.copyBlob = function (sourceContainer, sourceBlob, targetContainer, targetBlob, optionsOrCallback, callback) {
  ...
  var request = Request.put(targetResourceName)
    .withProperty(BlobConstants.ResourceTypeProperty, BlobConstants.ResourceTypes.BLOB)
    .withProperty(BlobConstants.SharedAccessPermissionProperty, BlobConstants.SharedAccessPermissions.WRITE)
    .withHeader(HeaderConstants.LEASE_ID_HEADER, azureutil.tryGetValueInsensitive('leaseId', options))
    .withHeader(HeaderConstants.SOURCE_LEASE_ID_HEADER, azureutil.tryGetValueInsensitive('sourceLeaseId', options))
    .withHeader(HeaderConstants.COPY_SOURCE_HEADER, '/' + this.storageAccount + '/' + sourceResourceName)
    .addOptionalMetadataHeaders(options.metadata);

  this._executeRequest(request, null, blobResult, null, options, callback);
};
...
BlobService.prototype.createBlobPagesFromText = function (container, blob, text, rangeStart, rangeEnd, optionsOrCallback, callback) {
  ...
  this._executeRequest(request, text, blobResult, null, options, callback);
};
...
BlobService.prototype.createBlobBlockFromText = function (blockId, container, blob, content, optionsOrCallback, callback) {
  ...
  this._executeRequest(request, content, null, null, options, callback);
};
...
BlobService.prototype.listBlobBlocks = function (container, blob, blocklisttype, optionsOrCallback, callback) {
  ...
  this._setHeadersFromBlob(request, blob);

  this._executeRequest(request, null, blockListResult, null, null, callback);
};
...
BlobService.prototype._setHeadersFromBlob = function (request, blob) {
  var setHeaderPropertyFromBlob = function (headerProperty, blobProperty) {
    if (blob[blobProperty]) {
      request.withHeader(headerProperty, blob[blobProperty]);
    }
  };
  ...
  if (blob) {
    ...
    if (!azureutil.objectIsNull(blob.rangeStart)) {
      ...
      request.withHeader(HeaderConstants.RANGE, range);
    }
    ...
    if (!azureutil.objectIsNull(blob.rangeStartHeader)) {
      ...
      request.withHeader(HeaderConstants.STORAGE_RANGE_HEADER, rangeHeader);
    }
    ...
    if (blob.metadata) {
      request.addOptionalMetadataHeaders(blob.metadata);
    }
  }
};
...
BlobService.prototype._updatePageBlobPagesImpl = function (container, blob, length, rangeStart, rangeEnd, writeMethod, options) {
  ...
  var request = Request.put(resourceName)
    ...
    .withHeader(HeaderConstants.CONTENT_LENGTH_HEADER, size)
