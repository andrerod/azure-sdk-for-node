...
ApnsService.prototype.createNativeRegistration = function (token, optionsOrCallback, callback) {
  throw new Error('Not yet implemented', token, optionsOrCallback, callback);
};
...
* @return {undefined}
*/
ApnsService.prototype.createTemplateRegistration = function (token, template, optionsOrCallback, callback) {
  throw new Error('Not yet implemented', token, template, optionsOrCallback, callback);
};
...
* @return {undefined}
*/
ApnsService.prototype.getRegistrationsByToken = function (token, optionsOrCallback, callback) {
  throw new Error('Not yet implemented', token, optionsOrCallback, callback);
};
