...
TopicResult.serialize = function (path, topic) {
  ...
  var odataHandler = new OdataHandler(null, null);
  var xml = odataHandler.serialize(atomQueue);
  return xml;
};

TopicResult.parse = function (topicXml) {
  var odataHandler = new OdataHandler(null, null);
  var topic = odataHandler.parse(topicXml, Constants.ATOM_TOPIC_DESCRIPTION_MARKER);
