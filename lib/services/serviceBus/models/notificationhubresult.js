...
exports.parse = function (xml) {
  ...
  var pos = result.id.lastIndexOf('/');
  result.NotificationHubName = result.id.substr(pos + 1);

  if (result.NotificationHubName.indexOf('?') !== -1) {
    result.NotificationHubName = result.NotificationHubName.substr(0, result.NotificationHubName.indexOf('?'));
  }
