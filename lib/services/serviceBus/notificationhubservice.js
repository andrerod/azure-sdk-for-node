...
* @return {undefined}
*/
NotificationHubService.prototype._sendNotification = function (hub, payload, optionsOrCallback, callback) {
  var options;
  ...
  this._executeRequest(webResource, payload, null, null, null, callback);
};
