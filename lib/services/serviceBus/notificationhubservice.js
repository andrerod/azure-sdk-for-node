...
NotificationHubService.prototype.getRegistration = function (registrationId, optionsOrCallback, callback) {
  throw new Error('Not yet implemented', registrationId, optionsOrCallback, callback);
};
...
* @return {undefined}
*/
NotificationHubService.prototype.getRegistrationByTag = function (tag, optionsOrCallback, callback) {
  throw new Error('Not yet implemented', tag, optionsOrCallback, callback);
};
