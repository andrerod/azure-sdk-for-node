...
WnsService.prototype.createNativeRegistration = function (channel, optionsOrCallback, callback) {
  ...
  var resultHandler = {
    parse: function (body) {
      return body.entry.content['WindowsRegistrationDescription'];
    }
  };

  this.notificationHubService._executeRequest(webResource, registrationXml, resultHandler, null, callback);
};
