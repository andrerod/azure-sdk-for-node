...
WnsService.prototype.createNativeRegistration = function (channel, optionsOrCallback, callback) {
  ...
  var registrationXml = registrationresult.serialize({
    WindowsRegistrationDescription: {
      ChannelUri: channel
    }
  });

  var webResource = WebResource.post(this.hubName + '/registrations/');

  this.notificationHubService._executeRequest(webResource, registrationXml, null, null, callback);
};

/**
* Creates a toast template registration.
*
* @param {string}             channel                     The device channel uri.
...
* @return {undefined}
*/
WnsService.prototype.createToastTemplateRegistration = function (channel, template, optionsOrCallback, callback) {
  throw new Error('Not yet implemented', channel, template, optionsOrCallback, callback);
};
...
* @return {undefined}
*/
WnsService.prototype.createTileTemplateRegistration = function (channel, template, optionsOrCallback, callback) {
  throw new Error('Not yet implemented', channel, template, optionsOrCallback, callback);
};
...
* @return {undefined}
*/
WnsService.prototype.createRawTemplateRegistration = function (channel, template, optionsOrCallback, callback) {
  throw new Error('Not yet implemented', channel, template, optionsOrCallback, callback);
};
...
* @return {undefined}
*/
WnsService.prototype.getRegistrationsByChannel = function (channel, optionsOrCallback, callback) {
  throw new Error('Not yet implemented', channel, optionsOrCallback, callback);
};
