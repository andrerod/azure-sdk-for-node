 ...
 * @class
 */
var SchedulerManagementClient = (function() {
  /**
   ...
   */
  function SchedulerManagementClient(credentials, baseUri) {
    if (credentials === null || credentials === undefined) {
      throw new Error('credentials cannot be null.');
    }
    
    SchedulerManagementClient['super_'].call(this, credentials);
  ...
  SchedulerManagementClient.prototype.getResourceProviderProperties = function(callback) {
    ...
    // Construct URL
    var url2 = this.baseUri + this.credentials.subscriptionId + '/resourceproviders/scheduler/Properties?resourceType=JobCollections';
  ...
  SchedulerManagementClient.prototype.registerResourceProvider = function(callback) {
    ...
    // Construct URL
    var url2 = this.baseUri + this.credentials.subscriptionId + '/services?service=scheduler.JobCollections&action=register';
  ...
  SchedulerManagementClient.prototype.unregisterResourceProvider = function(callback) {
    ...
    // Construct URL
    var url2 = this.baseUri + this.credentials.subscriptionId + '/services?service=scheduler.JobCollections&action=unregister';
 ...
 * @class
 */
var JobCollectionOperations = (function() {
  /**
  ...
  JobCollectionOperations.prototype.beginCreating = function(cloudServiceName, jobCollectionName, parameters, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + this.client.credentials.subscriptionId + '/cloudservices/' + cloudServiceName + '/resources/scheduler/JobCollections/' + jobCollectionName;
  ...
  JobCollectionOperations.prototype.checkNameAvailability = function(cloudServiceName, jobCollectionName, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + this.client.credentials.subscriptionId + '/cloudservices/' + cloudServiceName + '/resources/scheduler/JobCollections/?op=checknameavailability&resourceName=' + jobCollectionName;
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (resourceElement) {
          ...
          var planElement = js2xml.getElement(responseDoc, resourceElement, 'PLAN', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE');
          if (planElement) {
          ...
          if (intrinsicSettingsElement) {
            ...
            var planElement2 = js2xml.getElement(responseDoc, intrinsicSettingsElement, 'PLAN', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE');
            if (planElement2) {
              var planInstance2 = planElement2;
